...
In the previous lecture we saw how we could describe informally the behaviour of a program, such as \verb!LLen! (which computed the length of a linked list recursively) via Hoare triples with pre and postconditions encoded in separation logic. But how can we reason about the program in a formal way?
